...
### TLP (Toroidal Light Pulse)
A space-time non-separable, single-cycle electromagnetic pulse with toroidal topology, often called a "flying doughnut." Capable of carrying free-space skyrmionic textures. Proposed in HELIOS-3D as a robust "Topological Bus" for inter-module communication. `[DEMONSTRATED]`

### TOHE (Topological Orbital Hall Effect)
A 3D transverse current of orbital angular momentum generated by electrons passing through a 3D topological spin texture (e.g., a hopfion). Identified in 2025/2026 as the definitive electronic hallmark for hopfion detection. `[DEMONSTRATED for simulations]`
