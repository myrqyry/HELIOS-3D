export function Footer() {
  ...
  return (
    <footer className="border-t border-obsidian-3 bg-obsidian mt-auto">
      <div className="mx-auto max-w-6xl px-6 py-6 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between text-xs text-parchment-2 font-sans font-medium">
