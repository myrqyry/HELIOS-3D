    ...
    <div className="bg-obsidian-2/30 border border-obsidian-3/40 rounded-xl p-6">
      <div className="flex flex-col md:flex-row items-stretch justify-between gap-6">
        ...
        <div className="flex-1 bg-obsidian-2/50 border border-cyan-2/20 rounded-xl p-5 shadow-lg flex flex-col justify-between">
          <div>
            <div className="flex items-center justify-between mb-3">
              <span className="font-sans text-xs text-cyan-2 font-bold uppercase tracking-wider">Core A</span>
              <span className="px-2 py-0.5 bg-cyan-2/10 text-cyan-2 text-[10px] uppercase font-semibold font-sans rounded">Deterministic</span>
            </div>
          ...
          <div className="mt-4 pt-3 border-t border-obsidian-3/30 font-sans text-[10px] text-parchment-2 font-medium">
        ...
        <div className="flex flex-row md:flex-col items-center justify-center gap-2 py-2 md:py-0">
          ...
          <span className="font-sans text-[10px] text-amber uppercase font-bold">Bus</span>
        ...
        <div className="flex-1 bg-obsidian-2/50 border border-ember/20 rounded-xl p-5 shadow-lg flex flex-col justify-between">
          <div>
            <div className="flex items-center justify-between mb-3">
              <span className="font-sans text-xs text-ember font-bold uppercase tracking-wider">Core B</span>
              <span className="px-2 py-0.5 bg-ember/10 text-ember text-[10px] uppercase font-semibold font-sans rounded">Stochastic</span>
            </div>
      ...
      <div className="mt-6 bg-obsidian-3/20 border border-outline-variant/30 rounded-lg p-4 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 text-xs">
        ...
        <span className="font-sans text-[10px] text-parchment-2 font-medium bg-obsidian-2 border border-obsidian-3/50 px-2 py-0.5 rounded">
