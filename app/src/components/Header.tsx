...
const nav = [
  ...
  { href: '/docs/established/abstract', label: 'Docs' },
  { href: '/figures', label: 'Figures' },
  { href: '/docs/project-ops/deployment', label: 'Deploy' },
];
      ...
      <div className="mx-auto flex max-w-6xl items-center justify-between px-6 py-3">
        ...
        <div className="flex items-center gap-6">
          <nav className="flex gap-6 text-sm font-medium">
            {nav.map((item) => (
              <Link
                key={item.href}
                to={item.href}
                className="text-parchment-2 hover:text-ember focus-visible:text-ember focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-amber focus-visible:ring-offset-2 focus-visible:ring-offset-obsidian transition-colors duration-200 relative py-1 group"
              >
                {item.label}
          ...
          <select
            ...
            aria-label="Filter docs by stage"
          >
