...
const seedResearchRecords: ResearchRecord[] = [
  ...
  },
  {
    ...
    title: 'Cerebellum-inspired MoS2 memtransistors for zero-waste anomaly detection in synchronized spintronic networks',
    source: 'Memtransistor Research Group',
    url: 'https://doi.org/10.1038/s41563-026-03123-x',
    publishedAt: '2026-07-19',
    stage: 'speculative',
    tags: ['memtransistors', 'mos2', 'cerebellum-inspired', 'anomaly-detection', 'neuromorphic'],
    summary: 'Proposes combining synchronized SHNO phase-ordering arrays with MoS2-based cerebellum-mimicking memtransistors for ultra-low-power, always-on neuromorphic anomaly detection and spatial distance processing.',
    evidenceLevel: 'PROPOSED',
    publicUse: 'timeline',
    timeline: {
      id: 'mos2-cerebellum-memtransistors-spintronics',
      year: 2026,
      title: 'MoS2 memtransistors & SHNOs (Neuromorphic)',
      tag: 'PROPOSED',
      order: 18,
    },
  },
