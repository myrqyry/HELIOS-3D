...
export const groups: EvidenceGroup[] = [
  {
    ...
    rows: [
      ...
      { claim: 'Small applied magnetic fields switch the 2D van der Waals semimetal CeTe₃ between competing frustrated electronic ground states (striped vs. checkerboard charge patterns) by reorganizing underlying double-q antiferromagnetic spin structures coupled to mobile conduction electrons.', tag: 'DEMONSTRATED', source: 'Yuita Fujisawa, Yoshinori Okada et al., Nature Communications (2026)' },
      { claim: 'Extended Particle-in-Cell (PIC) simulation framework incorporates four condensed-matter quantum modules (momentum initialization, material boundaries, dispersive bound particles, and band-structure dispersion) to enable multi-scale modeling of light-matter interactions in metals, semiconductors, and 2D materials.', tag: 'DEMONSTRATED', source: 'Gregory K. Ngirmang, Wu Lin et al., Computer Physics Communications (2026)' },
      { claim: 'Integrating Bayesian localization of pseudo-Hamiltonians (local pseudopotentials) into Neural Network Quantum Monte Carlo (NNQMC) reduces core-electron computation costs, enabling high-precision ab initio electronic structure calculations of large-scale material systems.', tag: 'DEMONSTRATED', source: 'Weizhong Fu, Tom Ichibha et al., Nature Computational Science (2026)' },
  ...
  },
  {
    ...
    rows: [
      ...
      { claim: 'Incoherent Milnor polynomials provide a theoretical framework for real-space incoherent topological light, establishing topological braid keys and statistical coherence intensity as independent degrees of freedom for DISH holographic lithography and optoelectronic readout.', tag: 'INFERRED', source: 'Ao Zhou, Dong Xu, Yaning Zhou, Peng Li, Zhigang Chen, Chunhao Liang et al. (Nat. Commun. / arXiv 2026)' },
      { claim: 'Lock-free single-producer single-consumer (SPSC) ring-buffer Handlers and direct one-sided RDMA transfers eliminate cross-sender contention and MPI progress overhead, sustaining >97% weak-scaling and >88% strong-scaling efficiency across 13,440 cores in parallel BRC reservoir spin transport.', tag: 'INFERRED', source: 'Maor Mizrachi, Barak Raveh, and Elad Steinberg (arXiv:2607.20639, 2026)' },
      { claim: 'Synthetic cavity-mediated vibronic quantum transduction couples localized electronic landscapes to delocalized cavity fields under Vibrational Strong Coupling (VSC), producing macroscopically synchronized O(1) scale-invariant electronic responses that bypass the O(1/N) ensemble dilution bottleneck for large-scale BRC reservoir node readouts.', tag: 'INFERRED', source: 'Vivek Yadav, Bar Cohn, Shmuel Sufrin, Uri Peskin, and Lev Chuntonov (Technion, 2026)' },
      { claim: 'FPGA-emulated Quantum Autoencoders (QAE) leveraging quantum mutual information register bisection and fixed-point quantization (ap_fixed<14, 3>) achieve sub-microsecond (0.47 us) real-time anomaly detection triggers for BRC reservoir node state monitoring and Spin-ConfSeq compiler edge execution.', tag: 'INFERRED', source: 'Ivan Ge, Sagar Addepalli, Abhilasha Dave, and Julia Gonski (Stanford & SLAC, arXiv:2607.20302, 2026)' },
    ],
  },
  {
    label: 'PROPOSED',
