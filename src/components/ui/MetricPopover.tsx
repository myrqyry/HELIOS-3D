  ...
  return (
    <PopoverPrimitive.Root>
      <PopoverPrimitive.Trigger asChild>
        <button className="inline-flex items-center gap-1.5 px-2 py-0.5 rounded-full bg-amber/10 border border-amber/20 text-amber hover:bg-amber/20 transition-colors text-xs font-mono font-medium">
