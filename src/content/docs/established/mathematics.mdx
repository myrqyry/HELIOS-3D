...
The Hopf number is defined as the integral of the magnetic helicity over all space[^whitehead1947]:
...
In the HELIOS-3D architecture, the material parameters (exchange stiffness, DMI, and particularly the massive perpendicular magnetic anisotropy of the $Fe_3GaTe_2$ / $RuO_2$ heterostructure) are engineered to create a deep energy minimum for the hopfion state.[^ushakov2025]
...
[^whitehead1947]: J. H. C. Whitehead, *An expression of Hopf's invariant as an integral*, Proceedings of the National Academy of Sciences 33(5), 117–123 (1947). Formulates the integral topological linking representation for 3-sphere maps. [https://doi.org/10.1073/pnas.33.5.117](https://doi.org/10.1073/pnas.33.5.117)

[^ushakov2025]: V. Ushakov et al., *Hybrid Chiral Domain Walls and Soliton Confinement in Van der Waals Ferromagnets*, Physical Review Letters (2025). High-temperature magnetic anisotropy and topological soliton confinement in 2D van der Waals ferromagnet heterostructures. [https://doi.org/10.1103/PhysRevLett.134.026701](https://doi.org/10.1103/PhysRevLett.134.026701)
